...
<c:forEach var="t" items="${tweets}">       
 <div id="${t.tid}" class="w3-container w3-card w3-white w3-round w3-margin w3-animate-opacity"><br>
   ...
   <button type="button" class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-comment"></i> &nbsp;Comments</button>
   
   <p id="cT" contenteditable="true" class="w3-border w3-padding">Type your thoughts about this.</p>
   <button id="cM" type="button" class="w3-button w3-theme"><i class="fa fa-pencil"></i> &nbsp;Post Comment</button> 
 </div>
</c:forEach>
